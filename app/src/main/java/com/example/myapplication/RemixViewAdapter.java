...
public class RemixViewAdapter extends RecyclerView.Adapter<RemixViewAdapter.MyViewHolder>{
    private ArrayList<Track> tracks;
    private ItemClickListener mListener;


    public RemixViewAdapter(ArrayList<Track> tracks, ItemClickListener clickListener) {
        this.tracks=tracks;
    ...
    @NonNull
    @Override
    public RemixViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_row_mini,parent,false);
        return new MyViewHolder(view, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull RemixViewAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(tracks.get(0)==null)
            ...
            holder.tvNull.setText("No remixes available for this track.");
    }
