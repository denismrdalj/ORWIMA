...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>{
    ...
    private String noSamples = "nothing found.";

    public void setFilteredList(ArrayList<Track> filteredList){
        this.tracks = filteredList;
        notifyDataSetChanged();
    }

    public RecyclerViewAdapter(ArrayList<Track> tracks, ItemClickListener clickListener) {
        this.tracks=tracks;
    ...
    public void onBindViewHolder(@NonNull RecyclerViewAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(tracks.get(0)==null)
            ...
            holder.tvNull.setText(noSamples);
    }
